...
Layer_Mid_Sunrise.style.top = Rate_Mid_Sunrise*window.innerHeight+300+"px";
Layer_Main.style.top = Rate_Main*window.innerHeight+300+"px";
Layer_Near.style.top = Rate_Near*window.innerHeight+300+"px";
